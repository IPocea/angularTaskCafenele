...
import { ListaCafenele } from '../cafeneasaulocalitate';
...
export class PseudoApiService {
  private cafele: IProdusDisponibil[] = [
    {
      id: 1,
  ...
  public ListaLocalitati(): Observable<ICafeneaSauLocalitate[]> {
    return of(ListaCafenele.cafenele).pipe(delay(250));
  }

  public ProduseDisponibile(
    idCafenea: number
  ): Observable<IProdusDisponibil[]> {
    switch (idCafenea) {
      case 8786:
        return of([
          this.cafele[7],
